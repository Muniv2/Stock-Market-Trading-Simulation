...
void handleBuyOrder () {
    ...
    if ( orderBook.matchOrders(buyer , seller , tradePrice , tradeQty) ) {
        ...
        portfolio.settleTradeAmounts ( buyer , seller , tradePrice , tradeQty) ; // MUST complete before UI loop continues
    }
}
...
int main () {
    ...
    switch ( choice ) {
        ...
        case 9: {
            ...
            orderBook.buyOST.inorder(orderBook.buyOST.root, buyNodes);
            orderBook.sellOST.inorder(orderBook.sellOST.root, sellNodes);
            portfolio.portfolioOST.inorder( portfolio.portfolioOST.root, portNodes);
            portfolio.tradeHistoryOST.inorder(portfolio.tradeHistoryOST.root, tradeNodes);
        ...
        case 10: portfolio.displayLeaderboard(); break;
